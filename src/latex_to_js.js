 ...
 * Licensed under the Apache License, Version 2.0 (the "License"); you may not
   ...
   the License.
 */
export default function latex_to_js (input) {

	var init, fraction, square_root, nth_root, nth_power, sin, cos, tan, log, sinCosTanFramework, convert_others;
	...
	log = function(input) {
		return sinCosTanFramework("log", input);
	}
	...
	convert_others = function(func, input) {
		...
		log_pos = temp_input.search(/\\log\{/);

		arr = [frac_pos, root_pos, sqrt_pos, pow_pos, sin_pos, tan_pos, cos_pos, log_pos];
